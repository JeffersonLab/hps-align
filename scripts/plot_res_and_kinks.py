...
def main():
    ...
    trk_profile_plotter.plot_profileY("p_vs_tanLambda_top", xtitle="tan(#lambda)", ytitle="p [GeV]", rangeX=[0., 0.1], rangeY=[0., 6.], fit="[0] + [1]*x")
    trk_profile_plotter.plot_profileY("p_vs_tanLambda_bottom", xtitle="tan(#lambda)", ytitle="p [GeV]", rangeX=[-0.1, 0.], rangeY=[0., 6.], fit="[0] + [1]*x")
    ...
    if (doFEEs):
        fee_plots = FeeMomentumPlots()
        fee_plots.plot_histos("trk_params/Chi2_top_neg", do_fit=False, xtitle="e^{-} top #chi^{2}", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/Chi2_top_pos", do_fit=False, xtitle="e^{+} top #chi^{2}", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/Chi2_bottom_neg", do_fit=False, xtitle="e^{-} bottom #chi^{2}", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/Chi2_bottom_pos", do_fit=False, xtitle="e^{+} bottom #chi^{2}", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/p_bottom", do_fit=False, xtitle="e^{-} bottom p [GeV]", ytitle="Tracks", scale_histos=True, y_range=[0.,0.15])
        fee_plots.plot_histos("trk_params/p_top", do_fit=False, xtitle="e^{-} top p [GeV]", ytitle="Tracks", scale_histos=True, y_range=[0.,0.1])
        fee_plots.plot_histos("trk_params/p_slot_top", do_fit=False, xtitle="e^{-} top slot side p [GeV]", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/p_hole_top", do_fit=False, xtitle="e^{-} top hole side p [GeV]", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/p_slot_bottom", do_fit=False, xtitle="e^{-} bottom slot side p [GeV]", ytitle="Tracks", scale_histos=True)
        fee_plots.plot_histos("trk_params/p_hole_bottom", do_fit=False, xtitle="e^{-} bottom hole side p [GeV]", ytitle="Tracks", scale_histos=True)
        # fee_plots.plot_histos("trk_params/p5h_top", do_fit=False, xtitle="p [GeV]", ytitle="Tracks")
        # fee_plots.plot_histos("trk_params/p6h_top", do_fit=False, xtitle="p [GeV]", ytitle="Tracks")
        # fee_plots.plot_histos("trk_params/p7h_top", do_fit=False, xtitle="p [GeV]", ytitle="Tracks")
